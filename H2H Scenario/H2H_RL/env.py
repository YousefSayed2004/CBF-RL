...
class TwoVehicleLambdaEnv:
    ...
    def __init__(
        ...
        self.route_i = RouteSpec(name="vehicle_i", road_half_width=3.0, lane_axis="horizontal")
        self.route_j = RouteSpec(name="vehicle_j", road_half_width=3.0, lane_axis="horizontal")
