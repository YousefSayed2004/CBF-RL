...
class TwoVehicleLambdaEnv:
    ...
    def step(self, action: np.ndarray) -> Tuple[np.ndarray, float, bool, Dict]:
        ...
        if(inter_clear >= 0.5 and inter_clear > self.episode_min_intervehicle_clearance and ((self.x_i[3] + self.x_j[3])/2) >= 2.0):   
            reward += self.reward_cfg.high_speed_reward_weight
